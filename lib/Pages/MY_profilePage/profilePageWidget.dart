...
import 'profilePageModel.dart';
export 'profilePageModel.dart';
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'f1bvbey3' /* Mi cuenta VisualVocab */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '6w6wv95p' /* Configuracion de Notificacione... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
