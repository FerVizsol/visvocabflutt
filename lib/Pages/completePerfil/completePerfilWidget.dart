...
import 'completePerfilModel.dart';
export 'completePerfilModel.dart';
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            'yhcaf7r2' /* Completemos su perfil */,
          ),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                    ...
                    onTap: () async {
                      ...
                      if (selectedMedia != null &&
                        ...
                        if (selectedUploadedFiles.length ==
                          ...
                          showUploadMessage(context, 'Exitoso!');
                        } else {
                          setState(() {});
                ...
                Text(
                  FFLocalizations.of(context).getText(
                    'r6npjsue' /* Suba una foto de perfil que lo... */,
                  ),
                ...
                Padding(
                  ...
                  child: StreamBuilder<UsersRecord>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final hasProfileImage = _model.uploadedFileUrl.isNotEmpty;
                      final defaultProfileImage = 'https://firebasestorage.googleapis.com/v0/b/visualvocab-1167c.appspot.com/o/chocola2.PNG?alt=media&token=ca42b4bf-31bd-4141-8d42-aa3ca3e0e5e6';
                      final profileImageAsset = hasProfileImage ? _model.uploadedFileUrl : defaultProfileImage;
                      return FFButtonWidget(
                        onPressed: () async {
                          await buttonLoginUsersRecord.reference
                            ...
                            photoUrl: hasProfileImage ? profileImageAsset : defaultProfileImage,
                          ));
