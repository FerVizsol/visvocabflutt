...
import 'registerPageModel.dart';
export 'registerPageModel.dart';
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'oitrrwgg' /* Ingresa la informacion necesar... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                                          .override(
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                    FFLocalizations.of(context).getText(
                                      'joih97mn' /* Ingresa tu contraseña... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                    FFLocalizations.of(context).getText(
                                      'rzpiwq9p' /* Confirma tu contraseña */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                    ...
                                    hintText:
                                    FFLocalizations.of(context).getText(
                                      'eyfkffka' /* Re-Ingresa tu contraseña... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
